...
val Fizoomin: ImageVector
    get() {
        if (_Fizoomin != null) {
            return _Fizoomin!!
        }
        _Fizoomin = ImageVector.Builder(
            name = "Fizoomin",
            defaultWidth = 16.dp,
            defaultHeight = 16.dp,
            viewportWidth = 16f,
            ...
            path(
                ...
                moveTo(7.333f, 4.667f)
                curveTo(7.702f, 4.667f, 8f, 4.965f, 8f, 5.333f)
                verticalLineTo(9.333f)
                curveTo(8f, 9.702f, 7.702f, 10f, 7.333f, 10f)
                curveTo(6.965f, 10f, 6.667f, 9.702f, 6.667f, 9.333f)
                verticalLineTo(5.333f)
                curveTo(6.667f, 4.965f, 6.965f, 4.667f, 7.333f, 4.667f)
                close()
            }
            path(
                fill = SolidColor(Color.White),
...
private var _Fizoomin: ImageVector? = null
